...
> <h3><b>⚠️ Warning</b></h3>
>
> As of the 27th of August 2021, [disnake has ceased development](https://gist.github.com/Rapptz/4a2f62751b9600a31a0d3c78100287f1).
>
...
>
> However, if you personally decide that you wish to use a fork, I will allow Jishaku to honor your decision by removing the `disnake` package requirement. **This means, from now on, installing jishaku will not automatically handle installing `disnake`, you must choose a version to use yourself**. Any fork that you use must be compatible with the original (in that it supplies the `discord` module and its namespaces).
>
